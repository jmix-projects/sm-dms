package com.company.smdms.entity;
...
@Table(name = "DOCUMENT", indexes = {
        @Index(name = "IDX_DOCUMENT_ATTACHMENT", columnList = "WEBDAV_DOCUMENT_ID")
})
@Entity
public class Document {
    ...
    @JoinTable(name = "DOCUMENT_USER_WRITE_LINK",
            joinColumns = @JoinColumn(name = "DOCUMENT_ID", referencedColumnName = "ID"),
            inverseJoinColumns = @JoinColumn(name = "USER_ID", referencedColumnName = "ID"))
    @ManyToMany
    private List<User> writers;

    @JoinTable(name = "DOCUMENT_USER_READ_LINK",
            joinColumns = @JoinColumn(name = "DOCUMENT_ID", referencedColumnName = "ID"),
            inverseJoinColumns = @JoinColumn(name = "USER_ID", referencedColumnName = "ID"))
    @ManyToMany
    ...
    public void setWebdavDocument(WebdavDocument attachment) {
        this.webdavDocument = attachment;
    }
